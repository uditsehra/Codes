...
node* reverseAtIndex(node* head, int k)
{
    node* curr = head;
    node* prev = NULL;
    ...
    node* a = reverseRecursive(head);

    temp1 = temp1->next->next;    
    node* b = reverseAtIndex(temp1, 3);

    return mergeLinkedLists(a, b);
}
...
/* 	node* head1 = NULL;
    ...
    node* reverseByIndex = reverseAtIndex(head, 3);
    display(reverseByIndex);
